...
4. Se a pasta da linguagem ou do artista ainda não existir, sinta-se à vontade para criá-la!
5. O arquivo deve conter a letra da música. Seja criativo! Você pode usar comentários, strings, ou até fazer um programa que imprime a letra de forma estilizada.
6. Faça o Commit de suas mudanças (git commit -m 'Adiciona [Musica] em [Linguagem]').
7. Envie sua Branch (git push origin minha-musica-nova).
